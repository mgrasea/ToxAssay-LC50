...
The 24hr data remains the same because of 0% mortality across control samples. Thus, the 24hr data can be more reliable.
...
```{r}
# Example LC values (decimal)
LC_values_48 <- c(2.744686e-05 , 0.01427149)  # LC10 and LC50 in decimal
